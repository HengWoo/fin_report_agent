...
class ToolRegistry:
    ...
    def get_all_tools() -> List[Tool]:
        """Get all tools (simple + navigation + thinking + memory + legacy)."""
        # Note: Legacy and complex tools need to be added once extracted from server.py
        tools = []
        ...
        # TODO: Add legacy tools once extracted
        # TODO: Add complex analysis tools once extracted
        return tools